...
INSERT INTO `tbl_admin` (`id_admin`, `user`, `password`, `role`) VALUES
(1, 'stevani', '1234', 'admin'),
(2, 'lita', '123', 'pelanggan'),
(3, 'lita', '0948893467', 'pelanggan'),
(4, 'Rachel', '12345', 'pelanggan');
...
INSERT INTO `tbl_pelanggan` (`id_pelanggan`, `nama`, `no_telepon`, `instansi`) VALUES
(3, 'Stevani', '082277981060', 'Universitas satya Terra Bhinneka'),
(5, 'lita', '0948893467', 'unimed'),
(6, 'Rachel', '0895674321', 'USU');
...
(4, 1, 'Cash', 75000, '2026-06-04', 'Lunas'),
(5, 4, 'Gopay', 55000, '2026-06-23', 'Sudah Bayar'),
(6, 3, 'Cash', 75000, '2026-06-23', 'Sudah Bayar');
...
(3, 4, 3, 'Mikrobiologi', '2026-06-06 00:00:00', 75000, 'Sudah Bayar', 'Sampai ACC'),
(4, 4, 5, 'Ilmu Tanah', '2026-06-06 00:00:00', 55000, 'Sudah Bayar', 'Sampai ACC'),
...
(10, 3, 1, 'web', '2026-06-30 00:00:00', 76000, 'Selesai', 'yu'),
(11, 4, 6, 'web', '2026-06-04 00:00:00', 35000, 'Menunggu', '');
...
--
ALTER TABLE `tbl_pelayanan`
  MODIFY `id_pelayanan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
